...
INSERT INTO public.users (id, address, birth_date, created_when, email, first_name, last_name, login, middle_name, password, phone, role_id)
VALUES (3, 'Savanna, Sunrise 29, r. 20', '1998-06-06', '2022-09-10', 'savann@mailiz.ru', 'Dima', 'Zimenovich', 'Dima', 'Borisovich', 'dima', '+79881234568', 3);
INSERT INTO public.users (id, address, birth_date, created_when, email, first_name, last_name, login, middle_name, password, phone, role_id)
VALUES (2,
        ...
        2);
INSERT INTO public.users (id, address, birth_date, created_when, email, first_name, last_name, login, middle_name, password, phone, role_id)
VALUES (1, 'Mnogorechensk, Pobedy 56, r.5', '2000-06-10', '2023-06-10', 'reka@mailiz.ru', 'Vasya', 'Skobar', 'Admin', 'Petrovich', 'admin', '+79991234567', 1);
